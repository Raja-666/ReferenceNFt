...
export const CreateCollection = () => {
  ...
  const handleCreateCollection = async function onSubmit(data) {
    try {
      ...
      let result = await nftCreate(obj).unwrap();
      ...
      if (result.success) {
        ...
        setDescription('');
        setLogo(null);
        toast.success('Collection created successfully! sent Approval for Admin');
        // setTimeout(() =>{
        //   navigate("/createmint");
        // },3000)
    ...
    <>
              ...
              <div className="walletCnt mb-3">
                <h3> { address &&  address.slice(0,5) + "...."+ address.slice(-4) } </h3>
                {
                  isConnected ?
                    ...
                    :
                    <span className="walletLabel successLabel ml-auto" style={{ color: 'red' }}>Connect Wallet</span>
                ...
                <div className="col-12 mb-4">
                  ...
                  <div className="d-flex align-items-center flex-wrap">
                    <div className="imgCnt mr-4">
                      <img className="logoImg" src={logo ? logo : ''} alt="Logo Preview" />
                    </div>
      ...
      <Modal isOpen={modal} toggle={toggle} centered="true" className="curMdl createScsMdl" backdropClassName="selCurBp">
        <div className="createContent">
          ...
          <button type="button" className="btn btn-block gradientBtn" onClick={() => navigate("/mycollection")}>View Collection</button>
        </div>
        {/* <div className="createContent">
              <button className="btn closeBtn" onClick={toggle}>
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
